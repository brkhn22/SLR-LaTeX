...
% 15
Investigating ReLoRA \cite{weiss2025investigating} & 2025 & Custom (11M-66M) & N/A & OLMo Transformer & Pre-training Eval & Perplexity, BLiMP & N/A & Full-rank AdamW & Perplexity gap & N/A & N/A & N/A & ReLoRA underperforms full-rank training in SLMs; induces ill-conditioned updates and rank deficiencies. \\ \midrule
% 16
Symbiotic Agents \cite{chatzistefanidis2025symbiotic} & 2025 & Llama-3.2 (1B, 3B) & GPT-4o, Qwen-72B & Next-G O-RAN & Dynamic RAN Control & RMSE, Latency & Standalone LLM & Standalone SLM & 5x error reduction & <1ms control & N/A & 44\% PRB save & Symbiotic pairing bounds uncertainty; SLMs provide near LLM-level accuracy for edge constraints. \\ \midrule
% 17
...
% 19
Diagnosis Uncertainty \cite{gao2025uncertainty} & 2025 & Mistral-7B & Llama-3-70B & Feature Calibration & Diagnosis Gen & AUROC, ECE & XGB (Raw data) & N/A & 50.9 (Verbal) & N/A & N/A & N/A & Purely LLM-based methods (Logits/Confidence) are unreliable for clinical risk compared to traditional ML. \\ \midrule
% 20
ResilioMate Framework \cite{xiong2025resiliomate} & 2025 & LeptoConnect (1B, 7B) & GPT-4, Davinci & MAS Memory System & Multi-domain Agent & ROUGE, Success & GPT-4 & Qwen-7B, Llama-7B & 81.6\% of GPT-4 & N/A & N/A & Edge benefit & Dual-scale memory reduces redundancy by 26.4\% and semantic mistakes by 34.8\% in agent tasks. \\ \midrule
% 21
Arabic Med LLM \cite{ahmed2025arabic} & 2025 & Qwen-7B, TinyLlama & GPT-4, Claude 3 & PEFT + GraphRAG & Arabic Med QA & BLEU, Accuracy & GPT-4 & Base SLM & 84.3\% (14B) & 2.1-91ms & N/A & N/A & Hybrid RAG + LoRA is optimal; TinyLlama best for throughput while 14B best for factual consistency. \\ \midrule
% 22
Med QA Prompting \cite{rahman2024prompt} & 2024 & Gemma-2B, Llama-8B & Claude 3.5, Llama-405B & Prompt/Workflow & Med QA (MCQ) & Accuracy, Latency & Vanilla Large & Vanilla Small & 82.9\% (LATS) & 1s-107s & Token cost & N/A & Large models dominate; complex workflows like LATS provide minimal gain relative to massive latency/token costs. \\ \midrule
% 23
Student Feedback Gen \cite{abbas2025cognitive} & 2025 & Mistral-7B, CodeLlama & GPT-4o-mini & Sectional Processing & Assess. Feedback & F1-score & Human Expert & N/A & 0.99 (Mistral) & N/A & N/A & N/A & Mistral-7B provides more structured, actionable feedback than CodeLlama; sectional prompts improve reliability. \\ \midrule
% 24
TCM Formula Class. \cite{han2025weighted} & 2025 & Qwen-1.8B, BLOOM & InternLM, Qwen-14B & Ensemble Voting & TCM Classification & Accuracy, F1 & Qwen-14B (Single) & Fine-tuned SLM & 77.15\% (Vote) & N/A & N/A & N/A & Weighted voting using top-3 fine-tuned models significantly improves TCM herbal classification accuracy. \\ \midrule
% 25
PsA Flare Prediction \cite{dodson2026explainable} & 2026 & LGBM, XGBoost & Qwen-2.5 (32B) & Late Fusion & Flare Prediction & AUROC, Acc. & N/A & N/A & 93.7\% AUROC & N/A & N/A & N/A & LLMs on clinical letters improve sensitivity when ensemble-fused with structured gradient boosting models. \\ \midrule
% 26
VTE Identification \cite{liu2025vte} & 2025 & Mamba-130M, BERT & Phi-3 Mini (3.8B) & SSM vs Transf. & VTE Identification & F1, Accuracy & N/A & Hybrid Bi-LSTM & 98\% (Mamba) & Fast (SSM) & N/A & N/A & Mamba matches transformer accuracy while handling 8K context windows more efficiently than BERT. \\ \midrule
% 27
Multi-Agent Cloud-Edge \cite{zeng2026multiagent} & 2026 & Qwen2.5, Llama-8B & Qwen2.5-72B & Hybrid Cloud-Edge & Math Reasoning & Acc., Tokens & 94.19\% (72B) & 79.55\% (8B) & 94.19\% (Hybrid) & N/A & Token save & N/A & SLM-generated DAG for agent interaction reduces redundant communication and cuts token consumption by 35-70\%. \\ \midrule
% 28
Compos Mentis (SemEval) \cite{krishna2024compos} & 2024 & Mistral-7B & Claude 2.1 & Multi-Model Ensem. & Hallucination Det. & Accuracy, Rho & Claude 2.1 & Mistral-7B & 75.6\% (Ensem) & N/A & \$23 API total & N/A & Majority voting across role-based prompting strategies in SLM-LLM ensembles significantly improves detection truthfulness. \\ \midrule
% 29
Network RL Self-Opt \cite{chen2025integrating} & 2025 & GPT-2 (<1.5B) & None & Hybrid SLM + RL & Traffic Prediction & MAE, MSE, Delay & LSTM, TCN & None & MSE 0.643 & 133-159ms & N/A & N/A & GPT-2 sequence predictions provide "foresight" for RL bandwidth scheduling, reducing packet loss and delay in dynamic conditions. \\ \midrule
% 30
3GPP Long-Context RAG \cite{alabbasi2024leveraging} & 2025 & Phi-2 (2.7B) & GPT-4o & FT-RAG Only & Telecom QA & Accuracy & 80.90\% & Base Phi-2 & 80.30\% (FT-RAG) & N/A & N/A & N/A & Optimized SLM-RAG using SelfExtend matches GPT-4o accuracy despite being 880x smaller by extending context to 8192 tokens. \\ \midrule
% 31
Academic RAG Opt. \cite{miller2024towards} & 2024 & Llama 2, Mistral 7B & GPT-3.5, GPT-4 & RAG Comparison & Academic QA & Hit Rate, Faith. & 75.31\% (Hit) & 56.79\% (Hit) & 75.31\% (GPT-4) & N/A & N/A & N/A & Multi-Query and Ensemble Retrieval drastically improve faithfulness; Mistral 7B is the most competitive OS model for this domain. \\ \midrule
% 32
Do you need an LLM? \cite{alabbasi2024rethinking} & 2025 & DistilBERT, ELECTRA & Flan-T5, Flan-UL2 & Two-tier Hybrid & Review Analysis & Acc., F1, Memory & 97.27\% (UL2) & 95.70\% (BERT) & 96.48\% (Hybrid) & 7.41ms (SLM) & Low (FLOPs) & N/A & Fine-tuned SLMs beat LLMs in domain-specific correlation; hybrid routing balances UL2 accuracy with SLM speed (>20x faster). \\ \midrule
% 33
FedHLM Token Trans. \cite{solat2025federated} & 2025 & Edge-deployed SLM & Cloud LLM & Hybrid Federated & Text Class. & Token Reduction & Traditional LLM & Static HLM & Negligible loss & N/A & Bandwidth save & N/A & FedHLM uses uncertainty-aware thresholds to cut LLM token transmission by 95\%; P2P resolution further reduces cloud reliance. \\ \midrule
% 34
Energy-per-Token \cite{wilhelm2025beyond} & 2025 & 1B to 9B SLMs & Larger LLMs & Energy-Aware & Text Gen/Reason & Joules, Acc. & LLM (No CoT) & SLM (No CoT) & +10.2\% (MMLU) & 47.1\% red. & Carbon focus & 32-60 mJ/tok & Groundbreaking: CoT on SLMs is energy-inefficient. It is often greener to use a large LLM without CoT than an SLM with it. \\ \midrule
% 35
AraSum: Arabic Medical \cite{lee2025democratizing} & 2025 & AraSum (Distilled) & JAIS-30B & Distilled Agent & Medical Sum. & BLEU, ROUGE & JAIS-30B & None & Outperformed 30B & N/A & Lower comp. & Lower env. & Distilled SLMs can outperform foundational 30B LLMs in domain-specific Arabic medical summarization while saving massive resources. \\ \midrule
% 36
HLMEA Entity Alignment \cite{jin2025hlmea} & 2025 & RoBERTa & GPT-3.5, Llama2 & Filter-then-Refine & Entity Alignment & Hits@1, MRR & Zero-shot LLM & BERT-INT & 87.2\% (Hits@1) & N/A & N/A & N/A & SLM filters candidates (Top-K) while LLM makes final choice; this unsupervised method beats SOTA supervised baselines. \\ \midrule
% 37
Collaborating QA Agents \cite{huynh2025collaborating} & 2025 & Qwen-0.5B, DeepSeek & None & SLM-Only MAS & Math Reasoning & Acc., Tokens & Vanilla LLM & Single-agent & Beat LLM & 1.8x overhead & 1.2k tokens & N/A & Adversarial debate between ultra-small SLMs (proponent/opponent/arbitrator) drives reasoning better than increasing size. \\ \midrule
% 38
Cybersecurity Scams \cite{aldaoud2024enhancing} & 2024 & DistilBERT, BERT & GPT-4o, Claude 3 & Comparison/Ens. & Phishing Det. & Accuracy & Zero-shot LLM & Random Forest & 98.50\% (Ens) & Low latency & N/A & N/A & Fine-tuned SLM ensembles close the gap with zero-shot LLMs for real-time scam prevention at fraction of cost/latency. \\ \midrule
% 39
Transportation Planning \cite{ying2025beyond} & 2025 & Phi-3-mini & GPT-4 & Comparison & Spatial Reason & Accuracy & 86-91\% (GPT-4) & 43-72\% (Phi-3) & 91\% (GPT-4) & N/A & N/A & N/A & GPT-4 excels at analytical GIS decision support; Phi-3-mini fails significantly at GNSS interpretation and math reasoning. \\ \midrule
% 40
TextNeX: Expert Network \cite{pintelas2025textnex} & 2025 & BERT, XLNet var. & Heavyweight LLM & Multi-Model Net & Text Class. & Acc, Robustness & Heavyweight LLM & Single Transf. & Highest SOTA & N/A & High eff. & N/A & A weighted "Network of Experts" made of lightweight SLMs can beat massive models if orchestrated via quadratic programming. \\ \midrule
% 41
Olfactory Multimodal \cite{estebanromero2025synthesizing} & 2025 & CLIP, CamemBERT & Multimodal LLM & Hybrid Ensemble & Olfactory Match & Macro F1-score & Zero-shot MLLM & CLIP & 0.7618 (F1) & N/A & N/A & N/A & Heavily quantized (QLoRA) multimodal SLMs learn specialized joint embeddings that outperform massive generic multimodal models. \\ \midrule
% 42
Type \& Call Graph Eval \cite{shivarpatna2025empirical} & 2025 & Llama, Mistral var. & GPT-4o, Mistral-123B & Comparison & Code Static Anal. & Prec., Recall & GPT-4o & Base Llama & Beat SOTA Type & N/A & N/A & N/A & LLMs beat traditional tools for Python Type Inference but fail significantly for Call Graphs due to lack of soundness/completeness. \\ \midrule
% 43
Distilling Math Reason \cite{zhu2024distilling} & 2024 & CodeT5, FlanT5 & GPT-4, PaLM-2 & Distilled Tool & Math Reasoning & Accuracy & GPT-4 & Base SLM & 42.45\% (0.77B) & N/A & Low hardware & N/A & "Equation-of-Thought" fallback (PoT -> EoT -> CoT) allows microscopic sub-billion SLMs to reach SOTA math reasoning. \\ \midrule
% 44
ColBERT RAG \cite{gichamba2024colbert} & 2024 & Phi-2 (2.7B) & None & FT-RAG Only & Telecom QA & Acc., Latency & N/A & Base Phi-2 (41\%) & 81.9\% (Phi-2) & ~2102 ms & N/A & N/A & Combining LoRA with ColBERT retrieval and response scoring allows Phi-2 to double its baseline technical QA accuracy. \\ \midrule
% 45
...
% 46
Token Level Routing (CITER) \cite{she2025token} & 2025 & Qwen2.5-0.5B & Qwen2.5-32B & Cloud-Assist Edge & Commonsense QA & Acc., TTFT, TBT & 100\% (LLM) & ~50\% (SLM) & +60\% over SLM & TTFT: 340ms & >80\% reduction & N/A & Routing only 7\% of tokens to the cloud LLM achieves a 60\% performance gain with significant cost and latency savings. \\ \midrule
% 47
Zero-Shot SLM Ensembles \cite{cielen2026exploring} & 2026 & Phi2, Mistral, Llama & GPT-4 Omni & Ensemble (Voting) & Sentiment Anal. & Acc, F1, Latency & 82.52\% (GPT) & ~75\% (SLM) & 81.95\% (Ens) & High (859s CPU) & AWS Fargate & N/A & Local SLM ensembles match GPT-3.5 accuracy and rival GPT-4 in zero-shot settings, providing a high-privacy alternative to cloud APIs. \\ \midrule
% 48
Dynamic Quality-Latency \cite{bao2025dynamic} & 2025 & Qwen2.5-3B & QwQ-32B & Wireless Edge & Multi-turn Dial. & Acc., Latency & 85.2\% (MMLU) & 65.7\% (MMLU) & 76\% (Target) & 70,784 ms (avg) & N/A & N/A & Reduces large model invocations by 10-20\%; modeling KV-cache recomputation costs is essential for efficient multi-turn dialogue routing. \\ \midrule
% 49
Edge Gen. Intelligence \cite{chen2025edge} & 2025 & Flan-T5, TinyLlama & GPT-4, Claude 3 & Central/Hybrid/Dec & Multi-task EGI & Throughput & Base LLMs & Base SLMs & N/A (Survey) & N/A & N/A & N/A & Hybrid EGI transforms edge intelligence by balancing local SLM preprocessing with central LLM reasoning for complex cognitive tasks. \\ \midrule
% 50
Item Difficulty Modeling \cite{li2025item} & 2025 & BERT, RoBERTa & GPT-4, Phi-3 & Ensemble (Aug.) & Medical Difficulty & RMSE & GPT-4 (Poor) & Base SLMs & RMSE 0.2926 & N/A & N/A & N/A & Fine-tuned SLM ensembles (BERT/RoBERTa) significantly outperform GPT-4 and previous SOTA in medical item difficulty prediction. \\ \midrule
% 51
BioAgents: Bioinformatics \cite{mehandru2025bioagents} & 2025 & Phi-3-mini & None & Multi-Agent (3) & Genomics/Code & Acc, Likert 1-5 & Human Expert & Base Phi-3 & 4/5 (Genomics) & N/A & N/A & N/A & Achieving human-expert performance in genomics; code generation remains difficult for SLM-only agents as task complexity increases. \\ \midrule
% 52
FIPO Prompt Optimiser \cite{amarasinghe2025fipo} & 2025 & Qwen-2.5, Phi-3.5 & GPT-4o-mini & Agentic Workflow & Prob. Formulation & Accuracy & 53\% (GPT-3.5) & 3\% (Qwen-2.5) & 54\% (Qwen-FIPO) & N/A & N/A & N/A & Incremental feedback integration allows SLMs to reach accuracy levels (54\%) comparable to much larger models in optimization tasks. \\ \midrule
% 53
Division-of-Thoughts \cite{shao2025dot} & 2025 & Llama 3-8B & GPT-4o & Hybrid Edge-Cloud & Logical Reasoning & Acc, C-Time, Cost & GPT-4o & Llama 3-8B & 85\% (Max) & 4.9s - 23.5s & 83.5\% saving & N/A & Dependency graph-based task decomposition enables parallel sub-task execution, cutting reasoning time by 66\% and costs by 83\%. \\ \midrule
% 54
Mixed Distillation (MD) \cite{li2024mixed} & 2024 & Llama2-7B, T5-Large & GPT-3.5-Turbo & Multi-task MD & Math Reasoning & Accuracy & 82.0\% (SVAMP) & WizardMath-7B & 85.5\% (CodeLlama) & N/A & N/A & N/A & Combining CoT and PoT as distillation signals allows 7B models to exceed the performance of the GPT-3.5-Turbo teacher on reasoning tasks. \\
\end{longtable}
\end{landscape}
\restoregeometry
